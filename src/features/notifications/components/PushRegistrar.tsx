...
// Registers the operator push service worker for the admin shell. Renders nothing.
// Registration is separate from subscription: the worker is always installed, but no
// notification is sent until a device is subscribed on /admin/notifications.
