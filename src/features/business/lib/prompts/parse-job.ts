...
- "Complex": genuinely complex task. Triggers: data recovery, hardware repair, PC build, PC assembly, full system migration, motherboard-level diagnosis, BIOS work, operating system reinstall paired with recovery.
