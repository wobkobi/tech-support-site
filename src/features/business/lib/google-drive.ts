...
// Google Drive v3 helpers for invoice storage. Finds or creates the "Invoices > {year}"
// folder tree (cached per yearCode), uploads/lists invoice PDFs, and reads spreadsheets
