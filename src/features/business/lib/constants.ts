...
// Fixed enumerations for the business ledger - subscription frequencies, expense
// categories, and payment/income methods - used to populate form selects and validate
// entries.
