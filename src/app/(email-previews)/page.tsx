...
export default function EmailPreviewsPage(): React.ReactElement {
  return (
    <PageShell>
      <FrostedSection>
        <main className="mx-auto flex w-full max-w-5xl flex-col gap-6 pt-4 pb-6 sm:pt-6 sm:pb-8">
          <section className="rounded-xl border border-seasalt-400/60 bg-seasalt-800 p-4 shadow-sm sm:p-6">
