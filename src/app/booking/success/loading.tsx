        ...
        >
          ...
          >
            ...
            <section className={cn(CARD, "flex flex-col items-center text-center")}>
              <Bone className={cn("mb-4 size-16 rounded-full")} />
              <Bone className={cn("mb-3 h-9 w-64 max-w-full sm:h-10")} />
              <Bone className={cn("mb-2 h-5 w-full max-w-lg")} />
              <Bone className={cn("mb-6 h-5 w-3/4 max-w-md")} />
              <div className={cn("flex flex-wrap justify-center gap-3")}>
                <Bone className={cn("h-9 w-32 rounded-xl")} />
                <Bone className={cn("h-9 w-28 rounded-xl")} />
                <Bone className={cn("h-9 w-28 rounded-xl")} />
              </div>
            </section>
            ...
            <section className={cn(CARD)}>
              <Bone className={cn("mb-3 h-6 w-48")} />
              <div className={cn("flex flex-col gap-2")}>
                {Array.from({ length: 4 }).map((_, i) => (
                  <Bone key={i} className={cn("h-5 w-full max-w-xl")} />
                ))}
              </div>
            </section>
            ...
            {/* Cancellation policy */}
            <section className={cn(CARD)}>
              <Bone className={cn("mb-3 h-6 w-44")} />
              <Bone className={cn("h-5 w-full max-w-2xl")} />
            </section>
          </div>
        </div>
      </div>
      <span className={cn("sr-only")}>Loading booking confirmation...</span>
    </main>
  );
}
