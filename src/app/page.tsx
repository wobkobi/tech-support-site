...
export default async function Home(): Promise<React.ReactElement> {
  ...
  return (
    <PageShell>
      <FrostedSection>
        ...
        <div className={cn("grid place-items-center pb-4 sm:pb-6")}>
          <Image
            ...
            priority
            draggable={false}
            className={cn("h-auto w-[300px] select-none sm:w-[340px] md:w-[500px] lg:w-[620px]")}
          />
        </div>

        {/* Text boxes */}
        <section className={cn("mx-auto flex w-full max-w-5xl flex-col gap-3 sm:gap-4")}>
          <div
            className={cn(
        ...
        {/* Support grid */}
        <section aria-labelledby="support" className={cn("mx-auto mt-4 w-full max-w-5xl sm:mt-6")}>
          <h2
            id="support"
      ...
      {/* Sticky footer */}
      <footer className={cn("mx-auto mt-4 w-fit max-w-[calc(100vw-2rem)] sm:mt-6")}>
        <div
          className={cn(
        ...
        >
          ...
          >
            <FaPhone className={cn("h-6 w-6 shrink-0 select-none sm:h-7 sm:w-7")} aria-hidden />
