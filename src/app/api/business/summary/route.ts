...
// Admin business summary endpoint. GET aggregates total income, GST-exclusive expenses,
// claimable GST, profit, and a tax reserve, plus the current month's income and expenses,
// and per-NZ-financial-year breakdowns via aggregateByFinancialYear (most recent year
// first).
