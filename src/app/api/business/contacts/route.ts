...
// Admin endpoint for the contact picker. GET fetches the operator's Google Contacts via
// the People API and returns a sanitised list (name, email, phone, company), dropping any
// entry with no id or no name/email.
