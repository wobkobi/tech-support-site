...
// Single source of truth for the public site origin. Reads `NEXT_PUBLIC_SITE_URL` and
// falls back to the canonical www host so canonical tags, sitemap, robots, JSON-LD and
// email links all agree on one host. A host mismatch makes Google treat a page as a
// duplicate ("Alternative page with proper canonical tag").
